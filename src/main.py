...
def check():
    ...
    (2.8, [0, 1, 3])
    (inf, [])
    (1, 1.8)********this is not isConnected -> return (-1, inf)********
    /////////check2()
    ...
    inf []
    ([1, 9, 2, 3], 2.370613295323088) **** this is not key 9. return ([1, 2, 3], 2.370613295323088)*****
    //////check3()
    (1, 4.0)***///this is not isConnected -> return (-1, inf)********
    ([1, 2, 3, 4], 4.5)
    """
    print("check0")
    check0()
...
def check0():
    ...
    g_algo.load_from_json("C:\\Users\\kotek\\PycharmProjects\\ex33\\data\\A5.json")
    g_algo.plot_graph()
...
def check2():
    """ This function tests the naming, basic testing over A5 json file.
      ...
      """
    g_algo = GraphAlgo()
    file = "C:\\Users\\kotek\\PycharmProjects\\Ex3\\data\\A5.json"
